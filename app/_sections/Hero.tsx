...
export default function Hero() {
  return (
    <div className="max-w-360 mx-auto flex flex-col justify-center items-center mt-10 md:mt-3 px-6 md:px-12 lg:px-20 2xl:px-24">
      ...
      <div className="mt-[25.5px]">
        <h1 className="text-center font-medium text-[#FFD846] leading-snug md:leading-[1.1]">
        ...
        <p className="text-[#CABC95] text-[15px] md:text-[24px] md:leading-7 max-w-144.5 mx-auto mt-2 text-center">
